...
<div style="margin-top:50px; text-align:center; padding: 0 20px;">
  <h3 style="color:#F5A100; margin-bottom:10px; font-size:1.4rem;">
    🤖 Try MSA AI Live
  </h3>
  <p style="color:rgba(255,255,255,0.5); margin-bottom:24px;">
    Interact with all 7 app screens below
  </p>
  <iframe
    src="https://kehindealx.github.io/msa-app-demo/"
    width="100%"
    height="850px"
    frameborder="0"
    style="border-radius:16px; max-width:1100px; display:block; margin:0 auto;"
    title="MSA AI App Demo">
  </iframe>
</div>